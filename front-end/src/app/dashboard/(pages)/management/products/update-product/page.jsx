    ...
    return (
        ...
        <div className="mt-6">
            ...
            <div className="flex items-center gap-4 pt-4">
                ...
                {selectedType === 'category' && <div className="p-4 bg-white rounded-lg border">محتوى إضافة تصنيف (قريباً)</div>}
                {selectedType === 'subCategory' && <div className="p-4 bg-white rounded-lg border">محتوى إضافة تصنيف فرعي (قريباً)</div>}
                {selectedType === 'brand' && <div className="p-4 bg-white rounded-lg border">محتوى إضافة علامة تجارية (قريباً)</div>}
            </div>
        </div>
        </>
    );
